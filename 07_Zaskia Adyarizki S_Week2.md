...
![Diagram alur workflow analisis](images/01_diagram_workflow.png)
...
![Diagram Venn irisan gen Atherosclerosis dan senyawa QLYD](images/02_venn_diagram_irisan.jpg)
...
![Jaringan PPI dari 15 gen irisan hasil STRING](images/03_ppi_network_string.png)
*Gambar 3. Jaringan Protein-Protein Interaction (PPI) dari 15 gen irisan hasil konstruksi STRING*

![Komponen jaringan yang saling terhubung di Cytoscape](images/04_cytoscape_network.jpg)
*Gambar 4. Komponen jaringan yang saling terhubung (ESR1, PPARG, FABP4, NR1H3) hasil visualisasi Cytoscape*

![Identifikasi hub protein dengan cytoHubba MCC](images/05_cytohubba_mcc.jpg)
...
![Enrichment Gene Ontology Biological Process](images/06_enrichment_biological_process.png)
*Gambar 6. Hasil enrichment analysis Gene Ontology Biological Process terhadap 15 gen irisan*

![Enrichment Gene Ontology Molecular Function](images/07_enrichment_molecular_function.png)
*Gambar 7. Hasil enrichment analysis Gene Ontology Molecular Function terhadap 15 gen irisan*

![Enrichment KEGG Pathway](images/08_enrichment_kegg_pathway.png)
